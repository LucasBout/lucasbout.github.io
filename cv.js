...
const secCv = document.querySelector(".secCv");
...
containerType.addEventListener("click", (e) =>{
    ...
    if(e.target.classList.contains("type-item") && !e.target.classList.contains("active")){
        ...
        // 
        secCv.querySelector(".ListCvContent.active").classList.remove("active");
        secCv.querySelector(target).classList.add("active");
    }
});